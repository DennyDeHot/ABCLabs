...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="single-slider section-overly slider-height2 d-flex align-items-center" background-color="#D3D3D3">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                                ...
                                <div class="select-Categories pt-80 pb-50">
                                    ...
                                    <div class="checkbox checkbox-primary">
                                        <asp:CheckBoxList ID="CheckBoxList1" runat="server" AutoPostBack="True"
                                            ...
                                            <asp:ListItem>Full Time Doctors</asp:ListItem>
                                            <asp:ListItem>Part Time Docters</asp:ListItem>
                                            <asp:ListItem>Visitng Docters</asp:ListItem>
                                        </asp:CheckBoxList>
                                    </div>
                                </div>
