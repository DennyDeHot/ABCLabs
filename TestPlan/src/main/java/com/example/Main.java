...
public class Main{
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement district = driver.findElement(By.xpath("//span[contains(text(), 'Select District')]"));
        ...
        WebElement districtOption = driver.findElement(By.xpath("//li[contains(text(), 'Anuradhapura')]"));
        ...
        Thread.sleep(2500);
        username.sendKeys("Denver@123");
        password.sendKeys("Denver@123");
        confirmPassword.sendKeys("Denver@123");
        fullName.sendKeys("Denver Marlon Dehoedt");
        address.sendKeys("67,colombo");
        mobile.sendKeys("1234567890");
        email.sendKeys("denver@fmail.com");
        district.click();
        ...
        WebElement clicklogin= driver.findElement(By.id("lbLoginOrLogout"));
        ...
        usernamee.sendKeys("Denver@123");
        passwordd.sendKeys("Denver@123");
        logintype.click();
